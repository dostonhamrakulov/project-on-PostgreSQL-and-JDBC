...
<TR VALIGN="top">
	...
	<TR VALIGN="top">
		...
		<TD WIDTH="20">&nbsp;</TD>
		<TD><FONT FACE="Arial,Helvetica" SIZE="2">&nbsp;&euro; <%=formatCurrency(personalPizza.getBasePrice()) %></TD>
	</TR>
	<%
	...
	<TR VALIGN="top">
		...
		<TD WIDTH="20">&nbsp;</TD>
		<TD><FONT FACE="Arial,Helvetica" SIZE="2">&nbsp;&euro; <%=formatCurrency(ingredient.getPrice())%></TD>
	</TR>	
	<%
	}
	%>	
	...
	<TR VALIGN="top">
		...
		<TD WIDTH="20">&nbsp;</TD>
		<TD><FONT FACE="Arial,Helvetica" SIZE="2">&nbsp;<B>&euro; <%=formatCurrency(personalPizza.calcTotalPrice())%></B></TD>
	</TR>			
	</TABLE>		
	<BR>
	<BR>
